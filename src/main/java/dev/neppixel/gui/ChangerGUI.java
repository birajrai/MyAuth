package dev.neppixel.gui;

import dev.neppixel.MyAuth;
import dev.neppixel.utils.APIUtils;
import dev.neppixel.utils.SessionChanger;
...
public class ChangerGUI extends GuiScreen {
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.id == 3100) {
            ...
            if (Objects.equals(MyAuth.originalSession.getToken(), mc.getSession().getToken())) {
