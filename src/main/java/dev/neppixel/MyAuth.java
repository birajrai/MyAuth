package dev.neppixel;

import dev.neppixel.gui.ChangerGUI;
import dev.neppixel.gui.SessionGUI;
import dev.neppixel.utils.APIUtils;
...
@Mod(modid = MyAuth.MODID, version = MyAuth.VERSION)
public class MyAuth {

    public static final String MODID = "myauth";
